describe(':: UtilsSrv', function() {
  ...
  describe(':: location()', function() {
    ...
    it(':: remapColSettings()', function() {
      var id1 = 'test1',
          id2 = 'test2';
      var stringSetting = '{"id": ' + id1 + ', "property": "foo"}; {"id": ' + id2 + ', "property": "foo"}';
      var colObj = service.remapColSettings(stringSetting);
      expect(colObj.hasOwnProperty(id1)).toBe(true);
      expect(colObj.hasOwnProperty(id2)).toBe(true);
    });
  });
});
