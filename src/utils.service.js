  ...
  angular
    ...
    .factory('utilsSrv', [
      ...
      function($location, $state, $window) {
        ...
        /**
         * @name remapColSettings
         * @description Rearranges KVP   based column setting into proper JSON
         * @param {String} Stringified JSON
         * @return {Object}
         */
        self.remapColSettings = function(colSettingsKvp) {
          var colSettings = colSettingsKvp.split(';');
          var retVal = {};
          angular.forEach(colSettings, function(value) {
            var colJson = angular.fromJson(value);
            retVal[colJson.id] = {
              visible: colJson.visible,
              available: colJson.available
            };
          });
          return retVal;
        }
        ...
        /**
         * @name remapColSettings
         * @description Returns flag to set visibility of the given column
         * @param {Object} Column settings
         * @return {Boolean}
         */
        self.setVisibility = function(col) {
          return (col.visible && col.available);
        }
         ...
         * @param  url {String}, name {String}, height {Number}, width {Number}
         */
        self.openInNewWindow = function(url, name, height, width) {
          $window.open(url, name,'height=' + height + ', width=' + width + ',left=10,top=10');
        };
